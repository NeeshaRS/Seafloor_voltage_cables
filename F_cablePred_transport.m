function [ transport ] = F_cablePred_transport(cable_choice)
% Compute the transport across the cables from the ECCO transports
...
for i=1:n
tempE = squeeze(transE(:,:,i));
tempN = squeeze(transN(:,:,i));
